...
def load_networks(net1, net2, dataset, split):
    weights = net1.state_dict()
    filename1 = './log/models/{}/checkpoints/classifier32_ARPLoss_{}{}_.pth'.format(dataset, split, '1')
    filename2 = './log/models/{}/checkpoints/classifier32_ARPLoss_{}{}_.pth'.format(dataset, split, '2')
    net1.load_state_dict(torch.load(filename1))
    net2.load_state_dict(torch.load(filename2))
